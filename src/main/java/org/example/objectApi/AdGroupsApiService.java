...
public class AdGroupsApiService {
    ...
    public String createAdGroup(final CreateSponsoredBrandsAdGroupsRequestContent createRequestContent) throws IOException, InterruptedException, ApiException {
