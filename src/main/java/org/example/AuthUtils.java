...
public class AuthUtils {
    ...
    private final static String SP_BASE_URL = "https://advertising-api.amazon.com";
    ...
    public static CampaignsApi getCampaignsApi() {
        ...
        final CampaignsApi campaignsApi = new CampaignsApi(apiClient);
    ...
    public static AdGroupsApi getAdGroupsApi() {
        ...
        final AdGroupsApi adGroupsApi = new AdGroupsApi(apiClient);
...
//        final ApiClient apiClient = new ApiClient(client);
//
//        final TargetsApi targetsApi = new TargetsApi(apiClient);
